...
<section class="banner-same-padding common-banner fourth-bg">
    <div class="container cust-container">
        ...
        <div class="content">
            <div class="main-title">
                <h1 class="title f-s-2">Privacy Policy</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="section-lg-gaps privacy-content">
    <div class="container cust-container">
        <div class="collect-div privacy-item">
            <div class="who-we-are-privacy">
                <h2 class="title f-s-4">Who we are</h2>
                <p>Our website address is: <a href="tlr.global.">tlr.global.</a></p>
            </div>
            <div class="data-collect-privacy">
                <h2 class="title f-s-4">What personal data we collect and why we collect it</h2>
                <div class="comment">
                ...
                <div class="embedded">
                    <h3 class="sub-title">Embedded content from other websites</h3>
        ...
        <div class="retain-data privacy-item">
            <h2 class="title f-s-4">How long we retain your data</h2>
        ...
        <div class="right-data privacy-item">
            <h2 class="title f-s-4">What rights you have over your data</h2>
            <p>If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.</p>
        </div>
        <div class="send-data">
            <h2 class="title f-s-4">Where we send your data</h2>
